...
type VariantType = "default" | "blocked" | "human-review-required" | "approved" | "published" | "unavailable"

const VARIANTS: VariantType[] = ["default", "blocked", "human-review-required", "approved", "published", "unavailable"]
    ...
    <main className="min-h-screen bg-gradient-to-b from-neutral-50 to-slate-100">
      ...
      <section className="border-b border-neutral-200 bg-white/50 px-4 py-12 md:px-8 md:py-16">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mt-3 text-lg text-neutral-600">Read-only workflow component for displaying canonical episode state</p>
          <div className="mt-6 flex gap-3">
            <div className="inline-block rounded-full bg-violet-100 px-4 py-2 text-sm font-semibold text-violet-900">EXPERIMENTAL</div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="flex justify-center">
            <EpisodeStateCard
              ...
              humanReviewStatus={current.humanReviewStatus}
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className={`rounded-lg border px-4 py-2 text-sm font-medium ${reduced ? "bg-violet-50 text-violet-900" : "bg-white text-neutral-700"}`}
            >
            ...
            {VARIANTS.map((v) => (
              <div key={v} className="rounded-lg border border-neutral-200 bg-white p-6">
                ...
                <div className="bg-neutral-50 p-4 rounded-lg">
                  <EpisodeStateCard {...fixtures[v]} reduceMotion={reduced} className="shadow-none" />
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="border-t border-neutral-200 bg-white/30 px-4 py-12 md:px-8 md:py-16">
        <div className="mx-auto max-w-6xl text-center">
          <p className="text-neutral-600">Component status: <span className="font-semibold">EXPERIMENTAL</span></p>
          <p className="mt-2 text-neutral-600">Next phase: <span className="font-semibold">VISUAL_REVIEW</span></p>
        </div>
      </section>
    </main>
  )
