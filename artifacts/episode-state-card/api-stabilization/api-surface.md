# Episode State Card â€” API Surface Analysis
...
- `episodeId` â€” unused; DOM identity uses `React.useId()`.
- `updatedAt` â€” unused presentation prop.
- `reduceMotion` â€” lab-only control removed from the production contract.
...
Validated deployed baseline: `3de31ebfa3d6001fb633d261de495f862757fc3a` â€” 17/17 accessibility regression tests PASS.
