...
// âŒ Type error: blockers cannot be empty
<EpisodeStateCard variant="blocked" blockers={[]} />

// âŒ Type error: humanReviewStatus must be "required" for this variant
...
`"unavailable"` means the manifest is missingâ€”a different domain than review status. Separating them reduces confusion and aligns types with semantics.
...
- 2026-08-06 10:00Z â€” Analysis and decision
- 2026-08-06 11:00Z â€” Implementation complete
- 2026-08-06 11:30Z â€” Tests and documentation complete
- 2026-08-06 12:00Z â€” Registry updated, ready for approval review

---

## See Also

- `docs/components/episode-state-card-api.md` â€” Full API reference with examples
- `docs/migrations/episode-state-card-experimental-to-stable.md` â€” Migration guide
- `tests/episode-state-card-api.test.ts` â€” API contract tests
- `artifacts/episode-state-card/api-stabilization/api-surface.json` â€” API surface snapshot
