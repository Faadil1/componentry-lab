# Episode State Card — Approval Review
...
**HumanReviewStatus:** `"not-required" | "required" | "completed"` — excludes `"unavailable"`
...
**PROMOTION_REVIEW** — Component is approved and ready for promotion consideration.
